<div x-data="{ selected: null }" id="faq" class="px-4 pt-20 pb-48 mx-auto max-w-7xl">
    ...
    <div class="space-y-4">
        @foreach ($items as $index => $item)
            <div class="overflow-hidden transition-all duration-300 bg-orange-100 border-2 border-[#18181B] border-b-4 rounded-xl shadow-input dark:shadow-primary/20 hover:shadow-lg">
                <button @click="selected === {{ $index }} ? selected = null : selected = {{ $index }}"
                    ...
                    <svg
                        ...
                        class="w-5 h-5 transition-transform duration-300 transform text-[#18181B]"
