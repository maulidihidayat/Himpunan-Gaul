<section class="container flex flex-col items-center justify-between h-screen gap-10 px-4 py-20 pt-20 mx-auto md:flex-row">
    ...
    <div class="max-w-xl">
        <h1 class="mb-4 text-[40px] font-bold leading-relaxed text-[#18181B] md:text-5xl">
            Selamat Datang di <span class="text-orange-500">HMPS Pendidikan Informatika</span>
        </h1>
        <p class="mb-6 text-[18px] leading-relaxed text-[#52525B]">
            Tempat di mana <span class="font-medium text-[#18181B]">inovasi teknologi</span> dan <span
                class="font-medium text-[#52525B]">pendidikan</span> bersatu
