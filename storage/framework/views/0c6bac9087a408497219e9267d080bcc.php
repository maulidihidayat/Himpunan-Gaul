<?php $__env->startSection('title', 'Hmps Pendidikan Informatika'); ?>
...
<?php $__env->startSection('content'); ?>
    <div
        ...
        <div class="flex justify-center order-1 md:justify-end md:order-2">
            <img src="<?php echo e(asset('images/logo/Mainlogo.png')); ?>" alt="Logo" class="object-contain w-56 md:w-72 lg:w-[320px]"
    ...
    <?php echo $__env->make('partials.hallo', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <section class="container relative px-3 py-10 mx-auto mt-10 md:px-10 md:mt-20 md:-mt-2">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <?php $__currentLoopData = $highlightNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $News): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('news.show', $News->slug)); ?>"
                    ...
                    <img src="<?php echo e(asset('storage/' . $News->image)); ?>" alt="Thumbnail"
                    ...
                    <p class="mt-2 text-sm text-[#52525B]">
                        ...
                        <?php echo e(\Carbon\Carbon::parse($News->publish_date)->format('d M Y')); ?>
        ...
        <div class="mt-6 text-right">
            <a href="<?php echo e(route('news.index')); ?>" class="font-medium text-orange-500 hover:underline">
                Selengkapnya →
            </a>
        </div>
    </section>
    ...
    <section class="container px-3 py-10 mx-auto mt-10 md:px-10 md:mt-20 md:-mt-2">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <?php $__currentLoopData = $highlightPencapaians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pencapaian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('pencapaian.show', $pencapaian->slug)); ?>"
                    ...
                    <img src="<?php echo e(asset('storage/' . $pencapaian->image)); ?>" alt="Thumbnail"
                        class="object-cover w-full h-40 mb-2 rounded-xl" />

                    <h3 class="text-lg font-bold text-[#18181B]">
                        <?php echo e($pencapaian->title); ?>

                    </h3>

                    <p class="mt-2 text-sm text-[#52525B]">
                        <i class="mr-1 far fa-calendar"></i>
                        <?php echo e($pencapaian->publish_date->format('d M Y')); ?>
        ...
        <div class="mt-6 text-right">
            <a href="<?php echo e(route('pencapaian.index')); ?>" class="font-medium text-orange-500 hover:underline">
                Selengkapnya →
            </a>
        </div>
    </section>
    ...
    <section class="container px-3 py-10 mx-auto md:px-10">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <?php $__currentLoopData = $highlightArtikels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artikel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('artikel.show', $artikel->slug)); ?>"
                    class="overflow-hidden transition-all duration-300 bg-white border-[#18181B] border-3 rounded-3xl hover:shadow-lg group-2 p-4 hover:bg-orange-50 max-w-md hover:shadow-md hover:border-b-7 hover:-translate-y-1">
                    <img src="<?php echo e(asset('storage/' . $artikel->image)); ?>" alt="Thumbnail"
                        class="object-cover w-full h-40 mb-2 rounded-xl" />
                    ...
                    <p class="mt-2 text-sm text-[#52525B]">
                        <i class="mr-1 far fa-calendar"></i>
                        <?php echo e($artikel->publish_date->format('d M Y')); ?>
        ...
        <div class="mt-6 text-right">
            <a href="<?php echo e(route('artikel.index')); ?>" class="font-medium text-orange-500 hover:underline">
                Selengkapnya →
            </a>
        </div>
    </section>
    ...
    <section class="container px-3 py-10 mx-auto md:px-10 ">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <?php $__currentLoopData = $highlightBeasiswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $beasiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('beasiswa.show', $beasiswa->slug)); ?>"
                    class="overflow-hidden transition-all duration-300 bg-white border-[#18181B] border-3 rounded-3xl hover:shadow-lg group-2 p-4 hover:bg-orange-50 max-w-md hover:shadow-md hover:border-b-7 hover:-translate-y-1">
                    <img src="<?php echo e(asset('storage/' . $beasiswa->image)); ?>" alt="Thumbnail"
                        class="object-cover w-full h-40 mb-2 rounded-xl" />

                    <h3 class="text-lg font-bold text-[#18181B]">
                        <?php echo e($beasiswa->title); ?>

                    </h3>

                    <p class="mt-2 text-sm text-[#52525B]">
                        <i class="mr-1 far fa-calendar"></i>
                        <?php echo e($beasiswa->publish_date->format('d M Y')); ?>
        ...
        <div class="mt-6 text-right">
            <a href="<?php echo e(route('beasiswa.index')); ?>" class="font-medium text-orange-500 hover:underline">
                Selengkapnya →
            </a>
        </div>
    </section>
    ...
    <section class="container relative px-3 py-10 mx-auto mt-20 mb-20 md:mt-32 md:px-10">
        ...
        <?php if($recentFeedbacks->count()): ?>
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <?php $__currentLoopData = $recentFeedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="transition bg-red-50 border-3 border-[#18181B] rounded-3xl hover:shadow-md">
                        ...
                        <p class="text-[18px] text-[#18181B] font-medium mb-2 flex items-center gap-4 px-6">
                            ...
                            <strong><?php echo e($feedback->sender_name); ?></strong>
                        </p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <?php echo $__env->make('partials.faq', ['items' => $items], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    
    <?php echo $__env->make('partials.yotube', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('partials.tiktok', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>



<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\skripsi-cihuy\resources\views/welcome.blade.php ENDPATH**/ ?>